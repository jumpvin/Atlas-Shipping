...
define( 'ATLAS_SHIPPING_VERSION', '0.1.5' );
define( 'ATLAS_SHIPPING_SCHEMA_VERSION', '0.1.2' );
define( 'ATLAS_SHIPPING_BUILD_DATE', '2026-07-29' );
define( 'ATLAS_SHIPPING_BUILD_ID', 'f52b8e' );
