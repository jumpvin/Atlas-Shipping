...
class Frontend {
 ...
 public function register_assets(){
  ...
  wp_register_script('atlas-shipping-app',ATLAS_SHIPPING_URL.'assets/js/app.js',array('atlas-shipping-navigation','atlas-shipping-pages'),ATLAS_SHIPPING_VERSION,true);
 ...
 private function enqueue_assets(){ wp_enqueue_style('atlas-shipping-app'); wp_enqueue_script('atlas-shipping-app'); }
 public function render_shortcode(){
  ...
  if($identity){
   ...
   wp_localize_script('atlas-shipping-app','AtlasShippingApp',array(
    'version'=>ATLAS_SHIPPING_VERSION,'frontendVersion'=>self::FRONTEND_VERSION,'buildFingerprint'=>ATLAS_SHIPPING_BUILD_FINGERPRINT,
    'defaultRoute'=>'home','routes'=>self::routes(),'loginUrl'=>add_query_arg('atlas_session_expired','1',get_permalink()),
