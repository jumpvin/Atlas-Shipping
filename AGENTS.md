...
- Current implemented product build: `0.1.7`
...
`ATLAS-M001 — Shipping Data Foundation` passed Architecture review. `ATLAS-M002 — Shipping Request Editor` is implemented and awaits Architecture review.
